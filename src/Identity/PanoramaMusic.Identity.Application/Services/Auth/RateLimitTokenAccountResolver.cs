...
/// </summary>
public sealed class RateLimitTokenAccountResolver(
	IRefreshTokenRepository refreshTokenRepository,
	IPasswordResetTokenRepository passwordResetTokenRepository)
{
	public async Task<Guid?> ResolveRefreshTokenAccountAsync(string rawToken, CancellationToken cancellationToken)
	{
	...
	public async Task<Guid?> ResolvePasswordResetTokenAccountAsync(string rawToken, CancellationToken cancellationToken)
	{
		var tokenHash = RawToken.From(rawToken).Hash;
