...
public class SavedReportDeletedTranslatorTests
{
	...
	private SavedReportDeletedTranslator CreateTranslator()
	{
		...
		return new SavedReportDeletedTranslator(_auditContextMock.Object, _userContextMock.Object);
	}

	[Fact]
	[Trait("AC", "322UC9")]
	public void Translate_SavedReportDeleted_MapsTypeActorTargetLaneAndDisplay()
	{
		var reportId = Guid.NewGuid();
		var creatorId = Guid.NewGuid();
		var domainEvent = new SavedReportDeleted(reportId, "Grade 4 Contacts", new StoredReportDefinition([], ["student.name"]), creatorId);
		...
		ShouldlyHelpers.Satisfy(
			...
			() => auditEvent.EventType.ShouldBe(ReportingAuditEventTypes.SavedReportDeleted),
