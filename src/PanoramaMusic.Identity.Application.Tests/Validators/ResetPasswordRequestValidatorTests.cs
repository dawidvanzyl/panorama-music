...
public class ResetPasswordRequestValidatorTests
{
	...
	public async Task Validate_EmptyToken_ReturnsFailureNamingToken()
	{
		...
		result.ShouldSatisfyAllConditions(
			...
			result => result.Errors.ShouldContain(e => e.PropertyName == nameof(ResetPasswordRequest.Token)));
	}
	...
	public async Task Validate_PasswordBelowLengthMinimum_ReturnsFailureNamingPassword()
	{
		...
		result.ShouldSatisfyAllConditions(
			result => result.IsValid.ShouldBeFalse(),
			result => result.Errors.ShouldContain(e => e.PropertyName == nameof(ResetPasswordRequest.NewPassword)));
	}
