...
public class CreateUserRequestValidatorTests
{
	...
	public void Validate_InvalidEmail_ReturnsFailureNamingEmail()
	{
		...
		result.ShouldSatisfyAllConditions(
			...
			result => result.Errors.ShouldContain(e => e.PropertyName == nameof(CreateUserRequest.Email)));
	}
	...
	public void Validate_EmptyRoles_ReturnsFailureNamingRoles()
	{
		...
		result.ShouldSatisfyAllConditions(
			result => result.IsValid.ShouldBeFalse(),
			result => result.Errors.ShouldContain(e => e.PropertyName == nameof(CreateUserRequest.Roles)));
	}
