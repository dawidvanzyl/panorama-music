...
template.innerHTML = `
  ...
  <div class="modal__backdrop">
    <div class="modal__card">
      ...
      <p class="modal__body">
        Are you sure you want to delete the user <span class="modal__email" id="modalEmail"></span>? This action cannot be undone.
      </p>
      <p class="modal__error" id="modalError"></p>
      <div class="modal__actions">
        <button class="modal__btn modal__btn--cancel" id="cancelBtn" type="button">Cancel</button>
        <button class="modal__btn modal__btn--delete" id="deleteBtn" type="button">Delete User</button>
      </div>
    </div>
  </div>
`;
