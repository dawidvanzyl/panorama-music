...
export default defineConfig({
  test: {
    ...
    tags: [
      ...
      { name: '317UC16', description: 'An in-operator checklist dropdown renders its options whether set before or after the element connects (#324)' },
      { name: '317UC17', description: 'Switching a filter operator to in starts its values empty rather than carrying over the prior value (#325)' },
      { name: '317UC18', description: 'An in-checklist dropdown stays open across a tick and only closes on the trigger or an outside click (R3)' },
